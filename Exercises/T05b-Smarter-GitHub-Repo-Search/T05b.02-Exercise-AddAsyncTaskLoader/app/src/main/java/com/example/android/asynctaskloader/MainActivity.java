...
public class MainActivity extends AppCompatActivity
    ...
    private static final int GITHUB_SEARCH_LOADER = 13;
    ...
    private void makeGithubSearchQuery() {
        ...
        if (TextUtils.isEmpty(githubQuery)) {
            mUrlDisplayTextView.setText("Please enter a query before searching...");
            return;
        }
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                String urlFromBundle = args.getString(SEARCH_QUERY_URL_EXTRA);

                // DONE (11) If the URL is null or empty, return null
                if (urlFromBundle == null || TextUtils.isEmpty(urlFromBundle)){
                    return null;
                }
                ...
                try {
                    URL searchURL = new URL(urlFromBundle);

...
public class MainActivity extends AppCompatActivity implements
    ...
    /* A constant to save and restore the weather data that is being displayed */
    private static final String WEATHER_DATA_EXTRA = "weather data";

    /*
     * This number will uniquely identify our Loader and is chosen arbitrarily. You can change this
     * to any number you like, as long as you use the same variable name.
     */
    private static final int WEATHER_DATA_LOADER = 14;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(WEATHER_DATA_LOADER, bundleForLoader, callback);
    }
